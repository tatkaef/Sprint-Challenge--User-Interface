...
It's semantic markup for web pages. It helps people for understand what kind of part(tag) they have and browsers can read this and display this.

2. What are the 4 areas of the box model?

margin, border, padding, contant
...
Git can keep each vertion project from any developer together with other vertions.

5. Define mobile-first design in your own words.

It need be more thin, you can hide not imrortant things.
